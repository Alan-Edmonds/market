...
def all_combiner(input): #this writes the combined.csv, which is all of the block trades near ask from all the input files
    ...
    with open('today1.csv', 'w') as f:
        ...
        for row in tqdm(data):
            writer.writerow(row)
#all_combiner(['OptionTradeScreenerResults_20200615', 'OptionTradeScreenerResults_20200616', 'OptionTradeScreenerResults_20200617'])
all_combiner(['OptionTradeScreenerResults_20200619'])
